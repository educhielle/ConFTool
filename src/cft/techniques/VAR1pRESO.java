...
public class VAR1pRESO
{
    ...
    {
        String fileNameOut = Util.getFileTitle(fileNameIn) + "VAR1pRESO." + Util.getFileExtension(fileNameIn);
    ...
    public static void apply(String fileNameIn, String fileNameOut) throws IOException
    {
        ...
        List<String> resoImm = new ArrayList<>();
                    ...
                    if (DB.isArithmetic(instruction))
                    {
                        ...
                        if (instruction.equals(add))
                        {
                            ...
                            for (String rightReg : shiftRightRegs)
                            {
                                ...
                                code.add(++i, Util.generateCommand(srli.getName(), listRightReg, listRightReg, resoImm, emptyList, emptyList, srli.getFormat()));
                            }
                        }
                    }
