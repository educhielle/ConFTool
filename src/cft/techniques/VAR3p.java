...
public class VAR3p
{
    ...
    {
        String fileNameOut = Util.getFileTitle(fileNameIn) + "VAR3p." + Util.getFileExtension(fileNameIn);
    ...
    public static void apply(String fileNameIn, String fileNameOut) throws IOException
    {
        ...
        System.out.println("Free (" + freeRegisters.size() + "): " + freeRegisters);
        ...
        System.out.println("Used (" + usedRegisters.size() + "): " + usedRegisters);
        System.out.println("Copy (" + copyRegisters.size() + "): " + copyRegisters);
